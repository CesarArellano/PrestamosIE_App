...
class MechanicsTabView extends StatelessWidget {
  final String textTitle;
  final bool isHomePage;

  MechanicsTabView(this.textTitle, this.isHomePage);
  ...
  Widget _customCard(BuildContext context, int i) {
    ...
    final card = Container(
      child: Column(
        children: <Widget>[
          FadeInImage(
            image: AssetImage((isHomePage) ? 'assets/img/mecanica.jpg' : 'assets/img/mecanica2.jpg'),
              ...
              children: [
                ...
                Center(
                  child: ElevatedButton.icon(
                    onPressed: (isHomePage) ? () => Navigator.pushNamed(context, 'generalMaterial',arguments: 2) : (){}, icon: Icon(Icons.remove_red_eye), label: Text('Detalles'),
                  ),
                )
